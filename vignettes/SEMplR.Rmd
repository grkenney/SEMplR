...
The getCoordinates function extracts promoter sequences and tests for predicted binding site enrichment in foreground sets using enrichmentSets. Significant enrichment of TF binding in the promoters of upregulated genes can provide mechanistic insight into gene expression changes.
...
result <- enrichmentSets(foreground_ids = genes_oi, 
